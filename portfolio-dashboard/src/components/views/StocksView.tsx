    ...
    <div className="space-y-10 pb-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          ...
          <div
            key={s.label}
            className="group relative bg-surface border border-border p-6 rounded-2xl overflow-hidden hover:border-accent/30 -all duration-300"
          >
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              {holdings.map((h: StockHolding) => (
                <tr 
                  key={h.ticker}
                  className="group hover:bg-white/[0.03] -colors"
                >
